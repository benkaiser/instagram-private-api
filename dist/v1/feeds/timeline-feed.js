...
class TimelineFeed extends FeedBase {
    constructor(session, limit = null) {
        super(...arguments);
        this.limit = limit;
    }
    get({ is_pull_to_refresh = null }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield new Request(this.session)
                ...
                .setBodyType('form')
                .generateUUID()
                .setData(Object.assign({ is_prefetch: '0', feed_view_info: '', seen_posts: '', unseen_posts: '', phone_id: this.session.device.phone_id, client_session_id: this.session.session_id, battery_level: '100', is_charging: '1', will_sound_on: '1', is_on_screen: true, timezone_offset: '2', is_async_ads_rti: '0', is_async_ads: '0', is_async_ads_double_request: '0', rti_delivery_backend: '0' }, extra))
                .send();
