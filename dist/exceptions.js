...
class AccountInactive extends APIError {
    constructor(account) {
...
class AccountBanned extends APIError {
    constructor(message) {
        super(message);
    }
}
exports.AccountBanned = AccountBanned;
class AccountActivityPrivateFeed extends APIError {
    constructor() {
...
class NotPossibleToVerify extends APIError {
    constructor() {
