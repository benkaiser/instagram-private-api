...
export declare class AccountInactive extends APIError {
    account: any;
    constructor(account: any);
}
export declare class AccountBanned extends APIError {
    constructor(message: any);
}
export declare class AccountActivityPrivateFeed extends APIError {
    constructor();
}
...
export declare class NotPossibleToVerify extends APIError {
    constructor();
}
